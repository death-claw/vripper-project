...
export class PostsComponent implements OnDestroy {
  ...
  constructor(
    ...
    this.gridOptions = <GridOptions>{
      ...
      onGridReady: () => {
        this.dataSource = new PostsDataSource(this.wsConnection, this.agGrid.api, this.zone);
        this.postsDataService.setGridApi(this.agGrid.api);
        this.dataSource.connect();
      },
      onSelectionChanged: () => this.selectionService.onSelectionChanged(this.agGrid.api.getSelectedNodes()),
      onBodyScroll: () => this.contextMenuService.closePostContextMenu(),
      onRowDataUpdated: () => this.postsService.setCount(this.agGrid.api.getDisplayedRowCount()),
    };
  }
